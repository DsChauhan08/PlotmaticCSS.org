...
<p class="action">
  ...
  <a href="https://github.com/DsChauhan08/" target="_blank" class="action-button github">GitHub Repo</a>
</p>

**Plotmatic CSS** is a modern CSS framework. It uses CSS utility classes to style HTML elements as charts.

The [source code is available on GitHub](https://github.com/DsChauhan08/). If you like the project, please consider to star the repo on GitHub.
